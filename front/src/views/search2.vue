  ...
  <div class="container-fluid p-0 m-0 row">
        ...
        <article class="col-12 d-flex justify-content-center">
            <div class="div-search">
                <div class="d-flex justify-content-center">
                    <h5 class="subtitle bold">Encontre suas Músicas Favoritas</h5>
                </div>
    ...
    <section class="right row" style=""> 
        <article class="col-12">
            <div v-if="sync" class="d-flex justify-content-center margin-top-custom">
                <c-loading ></c-loading>
            </div>
            <div v-if="!sync && Object.keys(musics).length != 0">
                <div><h2 class="bold">Resultados de artistas para {{searchWord}}</h2></div>
                <c-card-artist :artists="artists"></c-card-artist>
            </div>
            <div class="mt-4" v-if="!sync && Object.keys(artists).length != 0">
